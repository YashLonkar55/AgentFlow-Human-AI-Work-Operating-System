...
import LiveOutputPanel from '@/components/layout/LiveOutputPanel';
    ...
    <>
      ...
      <motion.header
        ...
        className="fixed top-0 left-0 right-0 z-50 flex items-center
                   justify-between px-5 py-3 border-b border-black/[0.06]"
        style={{
      ...
      >
        ...
        <div className="flex items-center gap-2.5">
          <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-blue-500
                          to-violet-600 flex items-center justify-center shadow-sm">
      ...
      <div className="relative z-10 flex h-screen pt-[48px] overflow-hidden">
        ...
        <motion.div
          ...
          className="flex-1 min-w-0 border-r border-black/[0.06] relative overflow-hidden"
        >
...
function StatusPill() {
  ...
  return (
    <motion.div
      ...
      className={cn(
        'hidden md:flex items-center gap-2 text-xs font-semibold',
        'px-3.5 py-1.5 rounded-full border border-black/[0.07] shadow-sm',
        c.text, c.bg,
      )}
    >
